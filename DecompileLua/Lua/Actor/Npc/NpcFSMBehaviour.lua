...
function L2_1(A0_2)
      ...
      if L7_2 ~= nil then
        ...
        if L9_2 ~= nil then
          ...
          for L12_2, L13_2 in L9_2, L10_2, L11_2 do
            ...
            L15_2 = L13_2.stateSuiteKey
            L14_2.stateSuiteKey = L15_2
            ...
            if L15_2 ~= nil then
              L15_2 = L13_2.moveType
              L14_2.moveType = L15_2
            else
              L15_2 = L7_2.defaultMoveType
              if L15_2 ~= nil then
                L15_2 = L7_2.defaultMoveType
                L14_2.moveType = L15_2
              end
            end
            L15_2 = L13_2.floatingHeight
            if L15_2 ~= nil then
              L15_2 = L13_2.floatingHeight
              L14_2.floatingHeight = L15_2
            else
              L15_2 = L7_2.defaultFloatingHeight
              if L15_2 ~= nil then
                L15_2 = L7_2.defaultFloatingHeight
                L14_2.floatingHeight = L15_2
              end
        ...
        L8_2.bornConfigId = 0
        L9_2 = L7_2.bornConfigId
        if L9_2 ~= nil then
          L9_2 = L7_2.bornConfigId
          L8_2.bornConfigId = L9_2
        end
  ...
  L3_2 = util
  L3_2 = L3_2.begin_sample
  L4_2 = "[NpcFSMBehaviour]CardScheduleData"
  L3_2(L4_2)
  L4_2 = A0_2
  L3_2 = A0_2.TryCreateCardSummonTask
  L5_2 = A0_2.ConfigData
  L5_2 = L5_2.CardScheduleData
  L3_2(L4_2, L5_2)
  L3_2 = util
  L3_2 = L3_2.end_sample
  L3_2()
...
function L2_1(A0_2, A1_2)
  ...
  if L2_2 == nil then
    ...
    L2_2 = A0_2.CreateTask
    L4_2 = TaskID
    L4_2 = L4_2.CARD_SUMMON_TASK_ID
    L5_2 = LuaTaskType
    L5_2 = L5_2.CARD_SUMMON
    L6_2 = "Card"
    L2_2 = L2_2(L3_2, L4_2, L5_2, L6_2)
    A0_2.cardTask = L2_2
    L2_2 = A0_2.cardTask
...
L1_1.TryCreateCardSummonTask = L2_1
function L2_1(A0_2, A1_2)
end
L1_1.OnEvent = L2_1
function L2_1(A0_2)
