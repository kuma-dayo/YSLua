...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2)
  ...
  L7_2 = A0_2.uActor
  L8_2 = L7_2
  L7_2 = L7_2.LoadSceneTagCoverEffect
  L9_2 = A1_2
  L10_2 = A2_2
  L11_2 = A3_2
  L12_2 = A4_2
...
L0_1.LoadSceneTagCoverEffect = L1_1
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  local L5_2, L6_2, L7_2, L8_2, L9_2, L10_2
  if A3_2 == nil then
    A3_2 = 0
...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2, A10_2)
  ...
  if L11_2 then
    L11_2 = print
    L12_2 = "BaseActorProxy:ShowBlackScreen "
    L13_2 = tostring
    L14_2 = A0_2.alias
    L13_2 = L13_2(L14_2)
    L12_2 = L12_2 .. L13_2
...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2, A10_2, A11_2)
  ...
  if L12_2 then
    L12_2 = print
    L13_2 = "BaseActorProxy:ShowBlackScreenInQuest "
    L14_2 = tostring
    L15_2 = A0_2.alias
    L14_2 = L14_2(L15_2)
    L13_2 = L13_2 .. L14_2
  ...
  if A9_2 ~= nil or A10_2 ~= nil then
    ...
    L12_2 = A0_2.uActor
    L13_2 = L12_2
    L12_2 = L12_2.ShowBlackScreenOptionalInQuest
    L14_2 = A1_2
    L15_2 = A2_2
    L16_2 = A3_2
    L17_2 = A4_2
  ...
  L12_2 = A0_2.uActor
  L13_2 = L12_2
  L12_2 = L12_2.ShowBlackScreenInQuest
  L14_2 = A1_2
  L15_2 = A2_2
  L16_2 = A3_2
  L17_2 = A4_2
...
L0_1.ShowBlackScreenInQuest = L1_1
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  local L5_2, L6_2, L7_2, L8_2, L9_2, L10_2
  L5_2 = A0_2.uActor
  L6_2 = L5_2
...
L0_1.LevelReadySafeCall = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2.uActor
  L2_2 = L1_2
  L1_2 = L1_2.IsSceneInitFinishAndReady
  return L1_2(L2_2)
end
L0_1.IsSceneInitFinishAndReady = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = A0_2.uActor
  L2_2 = L1_2
  L1_2 = L1_2.IsLeveReady
  return L1_2(L2_2)
end
L0_1.IsLeveReady = L1_1
function L1_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2.uActor
  L3_2 = L2_2
...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2)
  ...
  L10_2 = NG_HSOD_DEBUG
  if L10_2 and A9_2 then
    L10_2 = print
    L11_2 = "BaseActorProxy:TransmitPlayer->ShowBlackScreen "
    L12_2 = tostring
    L13_2 = A0_2.alias
    L12_2 = L12_2(L13_2)
    L11_2 = L11_2 .. L12_2
...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2, A10_2)
  ...
  if L11_2 then
    L11_2 = print
    L12_2 = "BaseActorProxy:TransmitPlayerWithText->ShowBlackScreen "
    L13_2 = tostring
    L14_2 = A0_2.alias
    L13_2 = L13_2(L14_2)
    L12_2 = L12_2 .. L13_2
...
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2, A10_2)
  ...
  if L11_2 then
    L11_2 = print
    L12_2 = "BaseActorProxy:TransmitPlayerWithDialogText->ShowBlackScreen "
    L13_2 = tostring
    L14_2 = A0_2.alias
    L13_2 = L13_2(L14_2)
    L12_2 = L12_2 .. L13_2
...
L0_1.NarratorOnlyTaskByDataSpecifyingResumeReminder = L1_1
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2)
  local L8_2, L9_2, L10_2, L11_2, L12_2
  if A0_2 ~= nil then
    L8_2 = A0_2.uActor
  ...
  L8_2 = print
  L9_2 = "error : NarratorOnlyTaskByData , self or uActor is nil."
  L8_2(L9_2)
  do return end
  ::lbl_10::
  if A3_2 == nil then
  ...
  if L8_2 then
    ...
    if nil ~= A7_2 then
      L9_2 = A0_2
      L8_2 = A0_2.OverrideNarratorResumeReminder
      L10_2 = A7_2
      L8_2(L9_2, L10_2)
    end
    L8_2 = A0_2.uActor
    ...
    if nil ~= L8_2 then
      ...
      L9_2 = L8_2.FinishEvent
      L11_2 = "+"
      L12_2 = A0_2.RecoverNarratorResumeReminder
      L9_2(L10_2, L11_2, L12_2)
      L10_2 = L8_2
      L9_2 = L8_2.DestroyEvent
      L11_2 = "+"
      L12_2 = A0_2.RecoverNarratorResumeReminder
      L9_2(L10_2, L11_2, L12_2)
      if A4_2 ~= nil then
...
function L1_1(A0_2, A1_2)
  ...
  if nil ~= A1_2 then
    L2_2 = print
    L3_2 = "Override narrator resume reminder"
    L2_2(L3_2)
    A0_2.TaskOnResumeOverrideReminder = A1_2
  end
end
L0_1.OverrideNarratorResumeReminder = L1_1
function L1_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Recover narrator resume reminder"
  L1_2(L2_2)
  A0_2.TaskOnResumeOverrideReminder = -1
end
L0_1.RecoverNarratorResumeReminder = L1_1
function L1_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2)
...
function L1_1(A0_2, A1_2)
  ...
  L2_2 = A0_2.uActor
  L3_2 = L2_2
  L2_2 = L2_2.EnterCombatSneakMode
  L4_2 = A1_2
  L2_2(L3_2, L4_2)
end
...
L0_1[L1_1] = L2_1
L1_1 = "RequestCoopInteractionFromSubStartPoint"
...
L0_1[L1_1] = L2_1
L1_1 = "RemoveCoopInteractionDataFromSubStartPoint"
function L2_1(A0_2, A1_2, A2_2)
  local L3_2, L4_2, L5_2, L6_2
  L3_2 = A0_2.uActor
  L4_2 = L3_2
...
L0_1[L1_1] = L2_1
L1_1 = "RemoveCoopInteractionData"
function L2_1(A0_2, A1_2)
  local L2_2, L3_2, L4_2
  L2_2 = A0_2.uActor
  L3_2 = L2_2
...
L2_1 = 0
L0_1[L1_1] = L2_1
L1_1 = "TaskOnResumeOverrideReminder"
L2_1 = -1
L0_1[L1_1] = L2_1
...
function L2_1(A0_2)
  ...
  L1_2 = nil
  L2_2 = A0_2.TaskOnResumeOverrideReminder
  if 0 <= L2_2 then
    L1_2 = A0_2.TaskOnResumeOverrideReminder
  else
    L1_2 = A0_2.TaskOnResumeReminder
  end
  L3_2 = A0_2
...
function L2_1(A0_2)
  ...
  L1_2 = L1_2(L2_2, L3_2)
  if L1_2 ~= nil then
    L2_2 = L1_2.IsPausedByUser
    if L2_2 == true then
      L2_2 = print
      L3_2 = "narrator is paused by user."
      L2_2(L3_2)
      return
    end
  end
  ...
  L2_2 = nil
  L3_2 = A0_2.TaskOnResumeOverrideReminder
  if 0 <= L3_2 then
    L2_2 = A0_2.TaskOnResumeOverrideReminder
  else
    L2_2 = A0_2.TaskOnResumeReminder
  end
  L4_2 = A0_2
  L3_2 = A0_2.SayReminder
  L5_2 = L2_2
  L7_2 = A0_2
  L6_2 = A0_2.GetShowReminder
  L8_2 = L2_2
  L9_2 = 0
